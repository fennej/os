...
#define PARTITION_OFSET 0*BLOCK_SIZE
#define INODE_OFSET 5*BLOCK_SIZE
#define USERT_OFSET 6*BLOCK_SIZE
#define BLOCKB_OFSET 7
#define INODEB_OFSET 8
#define SUPERBLOCK_OFSET 9

#define USERSAPCE_OFSET 10
...
int create_symlink(partition_t *part, const char *link_name, const char *target_name) {
    ...
    strcpy(part->space->data + data_block * BLOCK_SIZE, target_name);
...
int move_file_with_paths(partition_t *part, const char *source_path, const char *dest_path) {
    ...
    for (int i = 0; i < NUM_DIRECT_BLOCKS; i++) {
        ...
        if (block_num == -1) {
            ...
            dir_entries = (dir_entry_t *)(part->space->data + block_num * BLOCK_SIZE);
    ...
    dir_entries = (dir_entry_t *)(part->space->data + dir_block * BLOCK_SIZE);
